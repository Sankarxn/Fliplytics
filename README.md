...
# 🛒 Fliplytics: Smart Flipkart Expense Tracker
...
5.  Click **Load unpacked** and select the folder where you downloaded this repository.
6.  The **Fliplytics** icon should now appear in your toolbar!
## 🛠️ How to Use
1.  **Login**: Ensure you are logged into your [Flipkart account](https://www.flipkart.com/).
2.  **Open**: Click the extension icon and select **"Open Dashboard"**.
3.  **Sync**: Click the **Sync Orders** button on the dashboard. The extension will fetch your order history (this may take a few moments).
4.  **Analyze**: Explore the **Overview**, **Orders**, and **Analytics** tabs to see your insights.
